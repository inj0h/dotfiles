...
* Prelude: Local Configuration
  ...
  #+BEGIN_SRC emacs-lisp
    (load "~/dotfiles/emacs/lisp/prelude" 1)
  #+END_SRC
...
** Remote Repositories
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package diminish
       ...
       (dolist (diminished foo/diminished-modes) (diminish diminished))

       (setq foo/forced-diminished-modes '((subword  . subword-mode)))
      ...
      (use-package evil
        ...
        (setq foo/evil-leader-bindings
              '(("lc" . count-words-region)
                ("le" . foo/evil-apply-macro-to-region-lines)
                ("ls" . sort-lines)
                ("gr" . deadgrep)
        ...
        (defun foo/evil-apply-macro-to-region-lines ()
...
* Coda: Local Configuration
  ...
  #+BEGIN_SRC emacs-lisp
    (load "~/dotfiles/emacs/lisp/coda" 1)
  #+END_SRC
