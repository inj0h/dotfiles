     ...
     #+BEGIN_SRC emacs-lisp
       (setq user-var\prefix-vanilla-keybindings
             '(;; Buffer
               ...
               ("r"  . user-var\previous-goto-previous-buffer)

               ;; Text Formatting
               ("td" . user-var\add-word-to-dictionary)
               ("tr" . fill-region)
               ("tw" . whitespace-mode)))
...
** Utility Functions
   ...
   #+BEGIN_SRC emacs-lisp
     (defun user-var\add-word-to-dictionary ()
      ...
      (use-package evil
        ...
        (setq user-var\evil-motion-state-rebindings
              '((";"  . evil-ex)
                ...
                ("gc" . comment-dwim)
                ("zg" . user-var\add-word-to-dictionary)))
        ...
        (setq user-var\evil-leader-bindings
              '(("lc" . count-words-region)
                ...
                ("ls" . sort-lines)
                ("gr" . deadgrep)
                ("r"  . user-var\goto-previous-buffer)
                ("o"  . switch-to-buffer)
                ("e"  . find-file)
                ("tw" . whitespace-mode)
                ("n"  . other-window)
