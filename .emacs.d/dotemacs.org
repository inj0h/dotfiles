     ...
     #+BEGIN_SRC emacs-lisp
       (setq foo/emacs-custom-keybindings
             '(("<C-left>"  . move-beginning-of-line)
               ...
               ("C-S-k"     . foo/kill-line-to-beginning-of-line)
               ("C-p"       . transpose-chars)
               ("C-t"       . previous-line)
...
*** Pairs
    ...
    #+BEGIN_SRC emacs-lisp
      (setq foo/electric-pair-modes '(c++-mode
                                      emacs-lisp-mode
                                      java-mode
                                      lisp-interaction-mode
                                      sh-mode))

      (defun foo/electric-pair-disabled-modes (mode)
        (not (member major-mode foo/electric-pair-modes)))

      (setq electric-pair-inhibit-predicate
            'foo/electric-pair-disabled-modes)
